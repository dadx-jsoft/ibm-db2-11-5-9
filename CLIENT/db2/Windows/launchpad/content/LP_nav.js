...
function isIE()             {   return (navigator.appName.indexOf("Microsoft Internet Explorer") >= 0);}

function linkToIC()         {   top.openWindow(property('URL_IC'));   }
function linkToDB2Info()    {   top.openWindow(property('URL_DB2_INFO'));   }
function linkToPrereqInfo() {   top.openWindow(property('URL_PREREQ_INFO')); }
function linkToMemoryReq()  {   top.openWindow(property('URL_MEMORY_REQ')); }
function linkToRelease()    {   top.openWindow(property('URL_RELEASE')); }
function linkToWhatsNew()   {   top.openWindow(property('URL_WHATS_NEW')); }
function linkToWhatsChanged()   {   top.openWindow(property('URL_WHATS_CHANGED')); }
function linkToMigration()  {   top.openWindow(property('URL_UPGRADE')); }
function linkToIBMDB2Web()  {   top.openWindow(property('URL_IBM_DB2')); }
function linkToEXPCWeb()    {   top.openWindow(property('URL_EXPC')); }
function linkToIBMSpatialWeb()  {   top.openWindow(property('URL_SPATIAL')); }
function linkToIBMGeodeticWeb()  {   top.openWindow(property('URL_GEODETIC')); }
function linkToIBMIIWeb()  {   top.openWindow(property('URL_IBM_II')); }
function linkToIBMDSInfo()  {   top.openWindow(property('URL_LEARNMORE_DS')); }
function linkToDownloadIBMDS()  {   top.openWindow(property('URL_DOWNLOAD_DS')); }

//Added for Prereq -------------------------------------
function linkToAESE()   {       top.openWindow(property('URL_IBM')); }
function linkToESE() 	{	top.openWindow(property('URL_IBM')); }
function linkToWSE() 	{	top.openWindow(property('URL_IBM')); }
function linkToExp() 	{	top.openWindow(property('URL_IBM')); }
function linkToExpC() 	{	top.openWindow(property('URL_IBM')); }
function linkToPE() 	{	top.openWindow(property('URL_IBM')); }
function linkToRTCL() 	{	top.openWindow(property('URL_IBM')); }
function linkToClient() { 	top.openWindow(property('URL_IBM')); }
function linkToConSV()	{	top.openWindow(property('URL_IBM')); }
function linkToConPE()	{	top.openWindow(property('URL_IBM')); }
function linkToNLPACK() {	top.openWindow(property('URL_IBM')); }
function linkToDOCE() 	{ 	top.openWindow(property('URL_IBM')); }
function linkToGSE() 	{	top.openWindow(property('URL_REQUIREMENTS')); }
function linkToRCON() 	{	top.openWindow(property('URL_REQUIREMENTS')); }
function linkToLSDC() 	{	top.openWindow(property('URL_REQUIREMENTS')); }
function linkToCube() 	{	top.openWindow(property('URL_IBM')); }
function linkToVSAI() 	{	top.openWindow(property('URL_IBM')); }
function linkToTools() 	{	top.openWindow(property('URL_TOOLS')); }

function showWelcomeTitle()
{
    // initialize to "IBM Data Server Version x.x"
    document.getElementById("welcomeDB2").style.display = "none";
    document.getElementById("welcomeIBMDataServer").style.display = "block";
    
    if (( top.instArray != null ) || (top.instArray != undefined)) {
      for (i=0; i<top.instArray.length; i++) {
        if (top.instArray[i][0] != undefined) {
              ...
              (prod != "dsac"))
          {
            ...
            if ((isAvail == "1")) {
              // if any DB2 product is available, change the title to "DB2 Version x.x"
              document.getElementById("welcomeDB2").style.display = "block";
              document.getElementById("welcomeIBMDataServer").style.display = "none";
              break;
            }
          }
        }
...
// SIG // xt+XoZFETOPF2kB07BVT7+uyNzpYVis4yyp8JSfL8XSg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBC