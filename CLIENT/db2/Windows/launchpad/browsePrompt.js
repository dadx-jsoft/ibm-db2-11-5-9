...
function modalPrompt(windowTitle, userText, userValue, userHTML, exitValidator, width, height) {
    top.logCLPEnter("modalPrompt", arguments);
    var undefined;
	...
	{ // oops, the dataWin is dead, poll, waiting for the modeless dialog to close
        ...
        window.focus();
        top.logCLPExit("modalPrompt", arguments);
		return window._modalPrompt_['ReturnValue'];
    }
    catch(e) {
	do {
...
function modalPromptWithBrowse(windowTitle, userText, userValue, exitValidator, width, height) {
	...
	top.logCLPEnter("modalPromptWithBrowse", arguments);
...
"<\/script>",
	...
	top.logCLPExit("modalPromptWithBrowse", arguments);
...
function simpleBrowseDialog(options){
	...
	top.logCLPEnter("simpleBrowseDialog", arguments);
				...
				var dialogText = (options&&options.defaultText)?options.defaultText:(browseFor=='folder')?(property('browseFoldersPromptText')!='undefined')?property('browseFoldersPromptText'):'':(property('browseFilesPromptText')!='undefined')?property('browseFilesPromptText'):'';
							...
							buttons: [
									...
									},
									{
										...
										onclick: function(){ 
												...
												var returnVal = document.getElementById(id+"InputTextbox").value;
...
// SIG // uHf/swzcMpnmGpYa4Z/zKPxl4xk/LKrK5B7cRD+WbPWg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC58W3O
// SIG // jYJ9xv4rATePixFBgV/91gie5qVL02FDBLkyczANBgkq
// SIG // hkiG9w0BAQEFAASCAgAUtx2+EoqLzbHC/rIY0rQIwms4
// SIG // RcY9tYC5l+yrv7uj9+r6bO4b377OGfyE196i8nfdlKSr
// SIG // K1s5L2TOfsj2xcWVhZsXg7l/oQxMXdAOly7Eh/v8kehc
// SIG // WwkZGpScTkXDqGdmD9cCNdoRj8k0Mt3LOHt8Y+H0YHGM
// SIG // 1Htn4wHWFPgsRXUfiGjxB0uOuCncP0O84TEZSPIOohDP
// SIG // wjzEyE1AckjpMk/iHlOxx2sDcKPqF/tPu0tAq4DXcU5b
// SIG // iIEaxuUlbkkgMowg4THZ+ZPHfeTCCYpwz9VIY4pFcnKh
// SIG // X+3Y01/QfcRWqfP/3oNys2vgTlAWRQIJ58wgz8/VGZKA
// SIG // FUO1+eb3wjTCO0k6GODFrWBAM8AxIqfwi5cdyd3ERuwU
// SIG // DCHHVpw32wM0Eac0wl0fClvMzO/ZsA9IxB9QMML5M/Zn
// SIG // vz7mwEz6Gi2oLAeIjtpYpOYN3YCBl/k7uEpF8tp8RFKs
// SIG // SrBGXLCSG74bkX7oY106YuG7yeINwHirEjHMwT3P8NDB
// SIG // m9u2RYbwHfvgEakNkzWVOfGPL+G9GnpmCLySycN0mdp7
// SIG // kRSuc/99rUASzbDNyfu+7nkwWuJQD8pB/RdKkt2pJyRg
// SIG // q2Do+Sd6+00gZsKZGFn/ZgP6Wt4O9TnQFJ547gN5WrIa
// SIG // QlLYDtAfRFi63MPxpuJlY0oZddHCZa4PrDhpPyjX1aGC
...
// SIG // SIb3DQEJBTEPFw0yMzExMDUxOTA4MzdaMC8GCSqGSIb3
// SIG // DQEJBDEiBCCJ/FRb2wyc3l7a+IS4d2Qdqc9OvGTmyUkL
// SIG // 2InGe+YHRTANBgkqhkiG9w0BAQEFAASCAgAhFFHiT3Z6
// SIG // 5uwJyvFu00RQStcsKqB6wEBfhrfdsvfBIzY9r57zKM5v
// SIG // K31cco/nrTWVcxNAuVbEMevm48dogU1kRLQJJCnXKgnD
// SIG // XmqtusTWRlHO1kXRbd199nPq+TndOa5j47XvdJlmwPwl
// SIG // q8fxUWW7wjjs1YrxA+pQwnImShVdTMW1Iohn521AbJgP
// SIG // gseJyd7h6AeTMds/uzeLsZ8z2pBiyJs7mk4W3kXW296Y
// SIG // 8Ro9kFTzundgavn80hbtblyrHjUmiAOIUvzGM+HQFdzE
// SIG // 6N52xmvGMhGW2xAg8cgI85aok9co8Mmyv3wRst6f/42r
// SIG // dv4XbaT1p3Y6vCVMMP7CeWnc/MsrH8yAMRHuKXdFKi2Q
// SIG // XQdf7RxeNOLtaEYnUHBxjM/QbIm01qzdQvCLEGuGkqOu
// SIG // Mf/XTMgjJY7gky0XDQxbf9X3pxgYgQusWzYsZf7dsA+4
// SIG // F2X9H/OjdUAJiVYooqnUPz2MkgYXdLQzN560CkjHM7KN
// SIG // uOwTkFW3JDpj4ei9Qx4parRK40/IWysvEC4SZN65fyFX
// SIG // CznLNqDfzjCbX7bgzFV8eYmTwF4Gn6pDMTVhzXzJSFNn
// SIG // FEu2yuTgEfqKiDNZOk/jUntGla9bLAh74LLMZvkcZw6Y
// SIG // gZtGYGJu2BLgMbYyFDRK7RfHavT0g7Ji4jDMizs0R6dV
// SIG // Oidi0GDDl03www==
